			...
			<div class="user-right">
				<div class="user-right-nav">
					<el-breadcrumb separator-class="el-icon-arrow-right">
					  ...
					  <el-breadcrumb-item :to="{path:'/ucenter/saleslogpptp'}">PPTP扣费记录</el-breadcrumb-item>
					</el-breadcrumb>
				</div>
				<div style="padding:10px 0 0 10px;">
					<el-button type="primary" size="small" plain @click="goHttp">HTTP消费日志</el-button>
  					<el-button type="primary" size="small" disabled>PPTP消费日志</el-button>
				</div>
	...
	export default {
		...
		methods:{
			...
			getPageList: function() {
				...
				this.$http.get(this.vpn_host  + 'vpn/vpnuserBalanceLog', {
					params: {
						'page': page
					}
				}).then(
